...
library SpeciesRegistry {
    ...
    function baseStats(uint16 speciesId) internal pure returns (BaseStats memory) {
        ...
        if (speciesId == 5) {
            return BaseStats({hp: 130, atk: 60, def: 120, spd: 40, element: WATER});
        }
        if (speciesId == 6) {
            return BaseStats({hp: 110, atk: 140, def: 85, spd: 70, element: WATER});
        }
        if (speciesId == 7) return BaseStats({hp: 95, atk: 70, def: 75, spd: 95, element: NATURE});
        if (speciesId == 8) {
            return BaseStats({hp: 140, atk: 60, def: 130, spd: 25, element: NATURE});
        }
        if (speciesId == 9) {
            return BaseStats({hp: 100, atk: 100, def: 100, spd: 100, element: NATURE});
        }
        if (speciesId == 10) {
            return BaseStats({hp: 70, atk: 110, def: 50, spd: 140, element: ELECTRIC});
        }
        if (speciesId == 11) {
            return BaseStats({hp: 60, atk: 90, def: 40, spd: 150, element: ELECTRIC});
        }
        if (speciesId == 12) {
            return BaseStats({hp: 120, atk: 130, def: 100, spd: 110, element: ELECTRIC});
        }
